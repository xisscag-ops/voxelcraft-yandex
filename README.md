...
- 🔫 **Пистолет:** 3 слитка + 2 доски + палка на верстаке; **ЛКМ — выстрел**, **удерживать ПКМ — прицеливание** (зум камеры, ствол по центру экрана, разброс вчетверо меньше, шаг медленнее), выстрелы с паузой 0.36 с, патроны крафтятся из слитка и угля (1 → 8). Урон 5, пуля летит почти прямо и гаснет в первом блоке, причём **самой пули в воздухе не видно** — из ствола при выстреле вырывается **небольшой огонь**: пламя у дула, сноп искр и клуб дыма по направлению выстрела, отдача качает руку, в HUD — счётчик патронов. Затвор у пистолета **подвижный**: при выстреле он откатывается назад и возвращается пружиной (цикл 0.18 с), а из окна выброса вылетает **латунная гильза**; модель из 65 деталей (ствол, рамка, рукоять и кисть, которая её сжимает): затвор с передними и задними насечками, планка Пикатинни, латунный патронник в окне выброса, светящиеся точки прицела (стоят на затворе и ездят с ним), деревянные щёчки рукояти, а рукоять сжимает объёмная кисть (ладонь, пальцы, большой палец) — пистолет в руке держится в ладони, а не «висит у локтя»
- 🏔 **Горы и вершины как в Minecraft:** горная страна собирается ридж-шумом в четыре октавы с доменным варпом — это острые линии гребней с широкими долинами между ними, а не сплошные купола; зазубренные пики чередуются с перевалами, эрозия местами стачивает хребты в пологие предгорья. Крутые склоны оголяются до камня и гравия (трава держится только на полках и плато), снежные шапки ложатся неровной кромкой выше снежной линии; мир вырос до 80 блоков в высоту, поэтому вершины поднимаются на полсотни блоков над долинами; валуны и высокие скалы-пальцы встречаются только на голом скальном высокогорье — на лугах, в лесу и в снежных зонах каменных выростов нет
- 🌍 Процедурный бесконечный мир с **крупными** биомами-регионами (каждый тянется на сотни и тысячи блоков): плоские **поля-луга** с цветами (ровные площадки под застройку), **холмистые края** с мягкими волнами рельефа, высокие **скальные горы** с острыми гребнями и зубьями, **пустыни** с волнистыми дюнами и кактусами, снежные зоны, пляжи, вода и деревья; встречаются **ударные кратеры** с приподнятым валом и обсидиановым ядром, ступенчатые карьеры и извилистые разломы
- 🌲 **В каждом биоме — свои деревья:** в снежной тайге растут только ели, на предгорьях и склонах гор — только сосны, на холмистых краях — только дубы, в полях-лугах — разрежённые берёзовые рощи, а в равнинном лесу — дубы и берёзы; в пустыне деревьев нет вовсе (там кактусы). Смешанных «все породы в одну кучу» больше нет
- 🌿 **Лесная флора:** под кронами в тени селятся красные и бурые грибы, на опушках и прогалинах — кусты и ягодник с красными ягодами, а среди луговой травы попадаются васильки и ромашки; вся новая флора — непроходимый декор, срывается мгновенно и доступна в творческом наборе
- 🕳 **Пещеры стали крупнее:** отдельные извилистые ходы-«черви» разной ширины, которые уходят вглубь почти до сланцевого дна и поднимаются к поверхности, сужаются, ветвятся и заканчиваются тупиками; ходы длиннее и шире, подземные залы выросли (до 15 блоков в высоту), но пол по-прежнему выравнивается ступенями, чтобы в больших гротах не оставалось отвесных провалов; лазы с поверхности, сталактиты и сталагмиты, гравий, мох на стенах и руды в камне
- ⛏ **Заброшенные шахты с сундуками:** глубоко под землёй попадаются короткие штреки (6–10 блоков) с бревенчатыми опорами и настенными факелами; в тупике ждёт сундук с лутом, иногда — вторая «кладовая» или пустая печка; лут из таких сундуков (как и из сундуков в логовах) выдаётся один раз — пустые сундуки запоминаются в сохранении
- 🏘 **Деревни и жители:** на ровных полях встречаются деревни — 3–5 домов с бревенчатыми углами, цоколем, двухскатной крышей из полублоков, стеклянными окнами и дверью, вокруг булыжного колодца с водой и крышей; от дверей к колодцу ведут гравийные дорожки, стоят лампы-столбики; в некоторых домах — верстак или печь и сундук с припасами. В деревнях живут **жители** в цветных рясе (мельник, огородник, торговец): неспешно ходят между домами и колодцем, со сложенными руками, задумчиво «х-м-м-кают», смотрят на подошедшего игрока, от удара убегают; из дома дальше своей деревни не уходят. Отыскав деревню впервые, вы увидите тост «Деревня найдена!»
...
- 🎁 **Дроп с мобов:** с овцы падают шерсть и сырое мясо, с волка — мясо и **клык** (задел под будущие крафты), с зайца и птицы — мясо, с зомби — мясо и иногда слиток железа, с паука — палки и клык, с крипера — уголь, со слизня — палка, с деревенского жителя иногда выронится пшеница; в креативе лут не выпадает
...
- 🧱 Больше 50 типов блоков (с вариантами сторон и половинок): руды (уголь, железо, золото, алмаз), гравий, песчаник, лёд, мшистый камень, обсидиан, берёза, ель, кактус, деревянные и каменные плиты, **забор**, **наковальня**, **берёзовые доски**, верстак, печь и сундук; полублоки и заборы **корректно видны со всех сторон** — грани нестандартной высоты разворачиваются по своей нормали и больше не «прозрачнеют» с одной стороны; хотбар с выбором колесом/цифрами/тапом
...
- 🌳 **Тень от деревьев:** под кроной земля, вода и стены мягко притемняются — каждый слой листвы отнимает часть небесного света, ниже кроны тень постепенно рассеивается, поэтому пятно тени повторяет форму кроны и не превращается в чёрный круг
...
- 🌿 **Трава темнее:** текстура газона и травяной кромки притемнена глубже, поэтому луга не выглядят «светящимися» на солнце; декоративная трава, папоротник, клевер и цветы
...
- 💧 **Вода снова переливается:** анимация тайла воды и свет факела в руке больше не затирают друг друга в шейдере — раньше из-за этого вода не рисовалась вовсе (в WebGL2 шейдер не линковался, и весь водный слой пропадал вместе с текстурой)
- 🕊 Полёт (в креативе): двойной пробел / кнопка
- 🌅 **Полный цикл дня и ночи** со звёздами, солнцем и луной: ночь тёмная, но не «чёрный экран» — силуэты, рельеф и вода видны, а факелы по-прежнему задают свет; под землёй и под водой мгла приходит и уходит плавно, а F3 показывает текущую яркость, мглу и дистанцию тумана — по этим числам видно, что именно затемняет картинку
...
| ПКМ — поставить/использовать блок (печь открывает плавку, сундук — хранилище; с Shift — просто поставить блок рядом; лук — удержать и отпустить для выстрела; пистолет — удерживать для прицеливания, ЛКМ — выстрел) | Кнопка «🧱» — поставить/использовать блок (с пистолетом: удерживать — прицел, «⛏» — выстрел) |
...
| F3 — отладка: FPS, координаты, яркость, мгла и туман | — |
| Пауза — Esc | Кнопка «⏸» |
...
src/
  ...
  config.js        # константы
  world.js         # чанки, рельеф, пещеры, карьеры и разломы, шахты и деревни
  mesher.js        # меширование вокселей + ambient occlusion и тень от листвы
  shaders.js       # правки шейдеров three.js: свет факела в руке и анимация воды
  fog.js           # пещерная мгла: порог, цвет и плавный вход/выход
