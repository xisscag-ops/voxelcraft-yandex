...
- 🧱 14 видов блоков, хотбар с выбором колесом/цифрами/тапом
- ⛏ Разрушение с прогрессом (удерживайте ЛКМ), частицы, процедурные звуки
...
src/
  ...
  config.js        # константы
  world.js         # чанки, генерация рельефа и деревьев
