...
- 🔫 **Пистолет:** 3 слитка + 2 доски + палка на верстаке; **ЛКМ — выстрел**, **удерживать ПКМ — прицеливание** (зум камеры, ствол по центру экрана, разброс вчетверо меньше, шаг медленнее), выстрелы с паузой 0.36 с, патроны крафтятся из слитка и угля (1 → 8). Урон 5, пуля летит почти прямо и гаснет в первом блоке, у дула — вспышка, отдача и дым, в HUD — счётчик патронов; модель из 57 деталей (ствол, рамка, рукоять и кисть, которая её сжимает): затвор с насечками, планка Пикатинни, светящиеся точки прицела, деревянные щёчки рукояти, а рукоять сжимает объёмная кисть (ладонь, пальцы, большой палец) — пистолет в руке держится в ладони, а не «висит у локтя»
- 🏔 **Большие горы и скалы:** кроме обычных хребтов мир разрезают крупные горные массивы — они тянутся сотни блоков и поднимают вершины на десятки блоков над холмами (мягкий потолок не даёт им превратиться в плоскую столешницу); валуны и высокие скалы-пальцы встречаются только на голом скальном высокогорье, а снежные шапки и каменные склоны заметно разнообразят пейзаж — на лугах, в лесу и в снежных зонах каменных выростов больше нет
- 🌍 Процедурный бесконечный мир с биомами-регионами: плоские **поля-луга** с цветами (ровные площадки под застройку), **холмистые края** с мягкими волнами рельефа, высокие **скальные горы** с острыми гребнями и зубьями, **пустыни** с волнистыми дюнами и кактусами, снежные зоны, пляжи, вода и деревья; встречаются **ударные кратеры** с приподнятым валом и обсидиановым ядром, ступенчатые карьеры и извилистые разломы
