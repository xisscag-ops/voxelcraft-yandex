...
- 🌿 Трава и цветы на лугах (ставятся и ломаются как обычные блоки)
- 🐗 Мобы: кабаны бродят по земле, птицы летают в небе; можно спугнуть кликом
...
| ЛКМ (удерживать) — сломать, с трещинами | Тап — сломать; «⛏» — удерживать |
| ПКМ — поставить | Кнопка «🧱» — поставить |
| Клик по мобу — спугнуть | Тап по мобу — спугнуть |
...
src/
  ...
  mesher.js        # меширование вокселей + ambient occlusion + растения
  blocks.js        # типы блоков
  textures.js      # процедурный атлас текстур и текстуры трещин
  mobs.js          # мобы: кабаны и птицы (модели, ИИ, анимация)
