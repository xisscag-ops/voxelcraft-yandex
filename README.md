...
- ⚒ **22 рецепта крафта:** сетка 2×2 в инвентаре + **верстак** для рецептов 3×3; в списке рецептов и подсказках показаны описания предметов
...
- 🕳 **Пещеры:** меандрирующие тоннели, крупные подземные залы, лазы с поверхности, сталактиты и сталагмиты, гравий, мох на стенах и руды в камне
...
- 🧱 37 видов блоков: руды (уголь, железо, золото, алмаз), гравий, песчаник, лёд, мшистый камень, обсидиан, берёза, ель, кактус, верстак и печь; хотбар с выбором колесом/цифрами/тапом
...
| **Верстак** (поставить блок и нажать ПКМ) — сетка 3×3 | кирки, топоры и мечи из дерева и камня, **лук**, печь, кирпич, камень, сланец, стекло |
...
каждой печи сохраняются отдельно по её координатам.
...
| ПКМ — поставить/использовать блок (печь открывает плавку, лук — удержать и отпустить для выстрела) | Кнопка «🧱» — поставить/использовать блок |
...
src/
  ...
  inventory-ui.js  # окно инвентаря, список рецептов, подсказки и интерфейс печи
