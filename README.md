...
- ⚒ **24 рецепта крафта:** сетка 2×2 в инвентаре + **верстак** для рецептов 3×3; деревянный и каменный топоры, плиты, лук и стрелы; описания предметов доступны в списке и подсказках
...
- 🔦 **Факелы:** объёмная модель и пламя со свечением; рядом с факелом освещаются пещеры, вдали без источников остаётся темно
...
- 🧱 40 видов блоков: руды (уголь, железо, золото, алмаз), гравий, песчаник, лёд, мшистый камень, обсидиан, берёза, ель, кактус, деревянные и каменные плиты, верстак и печь; хотбар с выбором колесом/цифрами/тапом
...
| **Верстак** (поставить блок и нажать ПКМ) — сетка 3×3 | кирки, деревянный и каменный топоры, мечи, **лук**, печь, хлеб, кирпич, камень, сланец, стекло |
