...
- ⚒ **Крафт из 16 рецептов:** сетка 2×2 в инвентаре + блок **верстак** для рецептов 3×3 (кирки, топоры, мечи, лук); доски, палки, стрелы, стекло, кирпич, камень, сланец, светокамень, снег
...
- 🧱 33 вида блоков: руды (уголь, железо, золото, алмаз), гравий, песчаник, лёд, мшистый камень, обсидиан, берёза, ель, кактус; хотбар с выбором колесом/цифрами/тапом
...
| Где | Что доступно |
|---|---|
| Сетка **2×2** в окне инвентаря (E) | бревно → доски, палки, стрелы, светокамень, снег, 4 доски → **верстак** |
| **Верстак** (поставить блок и нажать ПКМ) — сетка 3×3 | кирки, топоры и мечи из дерева и камня, **лук**, кирпич, камень, сланец, стекло |
