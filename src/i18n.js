...
export const STRINGS = {
  ru: {
    ...
    furnace_ui_hint: 'ПКМ по печи открывает меню. Заберите готовое из правого слота.',
    furnace_input: 'Сырьё',
  ...
  en: {
    ...
    furnace_ui_hint: 'Right-click the furnace to open it. Collect finished items from the right slot.',
