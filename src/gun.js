...
export const PISTOL_PARTS = [
  ...
  // ---- Затвор и ствол ----
  // сам затвор: прямоугольный кожух, ходящий по рамке. При выстреле откатывается
  // назад (PISTOL_SLIDE_PARTS собираются в подвижную группу, см. main.js).
  ...
  // латунный зеркало патронника, видимое в окне выброса
  { name: 'chamberBrass', w: 0.012, h: 0.02, d: 0.05, color: 0xc7a24e, x: 0.0335, y: 0.034, z: -0.03 },
  // задняя крышка затвора — читаемый торец подвижной части
  { name: 'rearPlate', w: 0.068, h: 0.058, d: 0.012, color: METAL_D, y: 0.02, z: 0.094 },
  ...
  // передние насечки затвора — под хват «за дуло» при перезарядке
  { name: 'serrFL1', w: 0.006, h: 0.05, d: 0.013, color: POLY_D, x: -0.0455, y: 0.022, z: -0.162 },
  { name: 'serrFL2', w: 0.006, h: 0.05, d: 0.013, color: POLY_D, x: -0.0455, y: 0.022, z: -0.182 },
  { name: 'serrFL3', w: 0.006, h: 0.05, d: 0.013, color: POLY_D, x: -0.0455, y: 0.022, z: -0.202 },
  { name: 'serrFR1', w: 0.006, h: 0.05, d: 0.013, color: POLY_D, x: 0.0455, y: 0.022, z: -0.162 },
  { name: 'serrFR2', w: 0.006, h: 0.05, d: 0.013, color: POLY_D, x: 0.0455, y: 0.022, z: -0.182 },
  { name: 'serrFR3', w: 0.006, h: 0.05, d: 0.013, color: POLY_D, x: 0.0455, y: 0.022, z: -0.202 },
  // ствол, выступающий из затвора (ствол неподвижен: откатывается только затвор)
...
// Подвижный затвор: кожух, ребро, окно выброса, насечки, задняя крышка и
// прицел (мушка и целик стоят на затворе и двигаются вместе с ним). Ствол,
// казённая часть и рамка неподвижны — затвор ходит по ним, как у настоящего
// пистолета: при выстреле откатывается назад и возвращается пружиной.
export const PISTOL_SLIDE_PARTS = [
  'slide', 'slideRib', 'rearPlate', 'ejectPort',
  'serrL1', 'serrL2', 'serrL3', 'serrR1', 'serrR2', 'serrR3',
  'serrFL1', 'serrFL2', 'serrFL3', 'serrFR1', 'serrFR2', 'serrFR3',
  'frontSight', 'frontDot', 'rearSightBase', 'rearSightL', 'rearSightR', 'rearDotL', 'rearDotR',
];
// Ход затвора при выстреле (вдоль оси ствола, назад — в сторону +Z модели)
export const PISTOL_SLIDE_TRAVEL = 0.058;
